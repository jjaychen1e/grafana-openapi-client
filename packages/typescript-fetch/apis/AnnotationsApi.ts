...
export class AnnotationsApi extends runtime.BaseAPI {
     ...
     */
    async getAnnotationByIDRaw(requestParameters: AnnotationsApiGetAnnotationByIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ItemDTO>> {
        if (requestParameters['annotationId'] == null) {
            throw new runtime.RequiredError(
                'annotationId',
     ...
     * Get Annotation by ID.
     */
    async getAnnotationByID(requestParameters: AnnotationsApiGetAnnotationByIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ItemDTO> {
     ...
     * Find Annotations.
     */
    async getAnnotationsRaw(requestParameters: AnnotationsApiGetAnnotationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ItemDTO>>> {
        const queryParameters: any = {};
     ...
     * Find Annotations.
     */
    async getAnnotations(requestParameters: AnnotationsApiGetAnnotationsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ItemDTO>> {
