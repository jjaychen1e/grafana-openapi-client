...
import {
    ...
    PauseAllAlerts200ResponseFromJSON,
    PauseAllAlerts200ResponseToJSON,
    PauseAllAlertsCommandFromJSON,
    PauseAllAlertsCommandToJSON,
} from '../models/index';

export interface AdminApiPauseAllAlertsRequest {
...
export class AdminApi extends runtime.BaseAPI {
     ...
     */
    async pauseAllAlertsRaw(requestParameters: AdminApiPauseAllAlertsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PauseAllAlerts200Response>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling pauseAllAlerts().'
            );
        }
        ...
        const response = await this.request({
            path: `/admin/pause-all-alerts`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: PauseAllAlertsCommandToJSON(requestParameters['body']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => PauseAllAlerts200ResponseFromJSON(jsonValue));
    }

    /**
     * Pause/unpause all (legacy) alerts.
     */
    async pauseAllAlerts(requestParameters: AdminApiPauseAllAlertsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PauseAllAlerts200Response> {
        const response = await this.pauseAllAlertsRaw(requestParameters, initOverrides);
        return await response.value();
    }
