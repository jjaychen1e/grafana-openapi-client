...
export interface SyncTeamGroupsApiRemoveTeamGroupApiRequest {
    groupId: string;
    teamId: number;
}
...
export class SyncTeamGroupsApi extends runtime.BaseAPI {
     ...
     * @deprecated
     */
    async removeTeamGroupApiRaw(requestParameters: SyncTeamGroupsApiRemoveTeamGroupApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponseBody>> {
     ...
     * @deprecated
     */
    async removeTeamGroupApi(requestParameters: SyncTeamGroupsApiRemoveTeamGroupApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponseBody> {
