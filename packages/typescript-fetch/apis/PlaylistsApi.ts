...
import {
    ...
    PlaylistFromJSON,
    PlaylistToJSON,
    PlaylistDashboardFromJSON,
    PlaylistDashboardToJSON,
    SpecFromJSON,
    SpecToJSON,
...
export interface PlaylistsApiGetPlaylistDashboardsRequest {
    uid: string;
}
...
export class PlaylistsApi extends runtime.BaseAPI {
     ...
     * Get playlist.
     */
    async getPlaylistRaw(requestParameters: PlaylistsApiGetPlaylistRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Spec>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SpecFromJSON(jsonValue));
    }

    /**
     * Get playlist.
     */
    async getPlaylist(requestParameters: PlaylistsApiGetPlaylistRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Spec> {
     ...
     */
    async getPlaylistDashboardsRaw(requestParameters: PlaylistsApiGetPlaylistDashboardsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PlaylistDashboard>>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
                'Required parameter "uid" was null or undefined when calling getPlaylistDashboards().'
            );
        }
        ...
        const response = await this.request({
            path: `/playlists/{uid}/dashboards`.replace(`{${"uid"}}`, encodeURIComponent(String(requestParameters['uid']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(PlaylistDashboardFromJSON));
    }

    /**
     * Get playlist dashboards.
     */
    async getPlaylistDashboards(requestParameters: PlaylistsApiGetPlaylistDashboardsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PlaylistDashboard>> {
        const response = await this.getPlaylistDashboardsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get playlist items.
     */
    async getPlaylistItemsRaw(requestParameters: PlaylistsApiGetPlaylistItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Item>>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
     ...
     * Get playlist items.
     */
    async getPlaylistItems(requestParameters: PlaylistsApiGetPlaylistItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Item>> {
     ...
     * Update playlist.
     */
    async updatePlaylistRaw(requestParameters: PlaylistsApiUpdatePlaylistRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Spec>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
     ...
     * Update playlist.
     */
    async updatePlaylist(requestParameters: PlaylistsApiUpdatePlaylistRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Spec> {
