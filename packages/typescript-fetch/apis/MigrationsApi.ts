...
export class MigrationsApi extends runtime.BaseAPI {
     ...
     */
    async getCloudMigrationRunListRaw(requestParameters: MigrationsApiGetCloudMigrationRunListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CloudMigrationRunListDTO>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CloudMigrationRunListDTOFromJSON(jsonValue));
    }

    /**
     * Get a list of migration runs for a migration.
     */
    async getCloudMigrationRunList(requestParameters: MigrationsApiGetCloudMigrationRunListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CloudMigrationRunListDTO> {
