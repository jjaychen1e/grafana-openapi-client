...
export class UserPreferencesApi extends runtime.BaseAPI {
     ...
     */
    async getUserPreferencesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Spec>> {
     ...
     * Get user preferences.
     */
    async getUserPreferences(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Spec> {
