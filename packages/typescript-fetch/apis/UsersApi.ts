...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Get users.
     */
    async searchUsersRaw(requestParameters: UsersApiSearchUsersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SearchUserQueryResult>> {
        const queryParameters: any = {};
     ...
     * Get users.
     */
    async searchUsers(requestParameters: UsersApiSearchUsersRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SearchUserQueryResult> {
