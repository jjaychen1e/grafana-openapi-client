...
export class AdminProvisioningApi extends runtime.BaseAPI {
     ...
     */
    async adminProvisioningReloadNotificationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponseBody>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/admin/provisioning/notifications/reload`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Reload legacy alert notifier provisioning configurations.
     */
    async adminProvisioningReloadNotifications(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponseBody> {
        const response = await this.adminProvisioningReloadNotificationsRaw(initOverrides);
        return await response.value();
    }
