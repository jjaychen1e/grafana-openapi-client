...
export class OrgPreferencesApi extends runtime.BaseAPI {
     ...
     */
    async getOrgPreferencesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Spec>> {
     ...
     * Get Current Org Prefs.
     */
    async getOrgPreferences(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Spec> {
