...
export class ServiceAccountsApi extends runtime.BaseAPI {
     ...
     */
    async listTokensRaw(requestParameters: ServiceAccountsApiListTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenDTO>> {
        if (requestParameters['serviceAccountId'] == null) {
            throw new runtime.RequiredError(
                'serviceAccountId',
     ...
     * Get service account tokens
     */
    async listTokens(requestParameters: ServiceAccountsApiListTokensRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenDTO> {
