...
import {
    ...
    TrimDashboardCommandFromJSON,
    TrimDashboardCommandToJSON,
    TrimDashboardFullWithMetaFromJSON,
    TrimDashboardFullWithMetaToJSON,
} from '../models/index';
...
export interface DashboardsApiTrimDashboardRequest {
...
export class DashboardsApi extends runtime.BaseAPI {
     ...
     */
    async trimDashboardRaw(requestParameters: DashboardsApiTrimDashboardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TrimDashboardFullWithMeta>> {
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling trimDashboard().'
            );
        }
        ...
        const response = await this.request({
            path: `/dashboards/trim`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: TrimDashboardCommandToJSON(requestParameters['body']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => TrimDashboardFullWithMetaFromJSON(jsonValue));
    }

    /**
     * Trim defaults from dashboard.
     */
    async trimDashboard(requestParameters: DashboardsApiTrimDashboardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TrimDashboardFullWithMeta> {
        const response = await this.trimDashboardRaw(requestParameters, initOverrides);
        return await response.value();
    }
