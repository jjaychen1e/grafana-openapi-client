...
export class TeamsApi extends runtime.BaseAPI {
     ...
     */
    async getTeamPreferencesRaw(requestParameters: TeamsApiGetTeamPreferencesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Spec>> {
        if (requestParameters['teamId'] == null) {
            throw new runtime.RequiredError(
                'teamId',
     ...
     * Get Team Preferences.
     */
    async getTeamPreferences(requestParameters: TeamsApiGetTeamPreferencesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Spec> {
