...
export interface ReportsApiRenderReportPDFRequest {
    dashboardID: number;
    dashboardID2: number;
    title?: string;
    variables?: string;
...
export class ReportsApi extends runtime.BaseAPI {
     ...
     * Get a report.
     */
    async getReportRaw(requestParameters: ReportsApiGetReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ConfigDTO>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Get a report.
     */
    async getReport(requestParameters: ReportsApiGetReportRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ConfigDTO> {
     ...
     * @deprecated
     */
    async renderReportPDFRaw(requestParameters: ReportsApiRenderReportPDFRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
     ...
     * @deprecated
     */
    async renderReportPDF(requestParameters: ReportsApiRenderReportPDFRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<number>> {
