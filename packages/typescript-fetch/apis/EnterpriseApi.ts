...
export class EnterpriseApi extends runtime.BaseAPI {
     ...
     */
    async getTeamLBACRulesApiRaw(requestParameters: EnterpriseApiGetTeamLBACRulesApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponseBody>> {
     ...
     * Retrieves LBAC rules for a team.
     */
    async getTeamLBACRulesApi(requestParameters: EnterpriseApiGetTeamLBACRulesApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponseBody> {
     ...
     */
    async updateTeamLBACRulesApiRaw(requestParameters: EnterpriseApiUpdateTeamLBACRulesApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponseBody>> {
        if (requestParameters['uid'] == null) {
            throw new runtime.RequiredError(
                'uid',
     ...
     * Updates LBAC rules for a team.
     */
    async updateTeamLBACRulesApi(requestParameters: EnterpriseApiUpdateTeamLBACRulesApiRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponseBody> {
