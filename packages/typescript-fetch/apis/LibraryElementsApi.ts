...
export class LibraryElementsApi extends runtime.BaseAPI {
     ...
     */
    async getLibraryElementByNameRaw(requestParameters: LibraryElementsApiGetLibraryElementByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LibraryElementResponse>> {
     ...
     * Get library element by name.
     */
    async getLibraryElementByName(requestParameters: LibraryElementsApiGetLibraryElementByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LibraryElementResponse> {
