...
export class CorrelationsApi extends runtime.BaseAPI {
     ...
     */
    async getCorrelationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Correlation>>> {
        const queryParameters: any = {};
     ...
     * Gets all correlations.
     */
    async getCorrelations(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Correlation>> {
        const response = await this.getCorrelationsRaw(initOverrides);
        return await response.value();
    }
