...
export function RouteFromJSONTyped(json: any, ignoreDiscriminator: boolean): Route {
    ...
    return {
        ...
        'objectMatchers': json['object_matchers'] == null ? undefined : ((json['object_matchers'] as Array<any>).map(MatcherFromJSON)),
...
export function RouteToJSONTyped(value?: Route | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'object_matchers': value['objectMatchers'] == null ? undefined : ((value['objectMatchers'] as Array<any>).map(MatcherToJSON)),
