...
export function MetricRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetricRequest {
    ...
    return {
        ...
        'from': json['from'],
        'publicDashboardAccessToken': json['publicDashboardAccessToken'] == null ? undefined : json['publicDashboardAccessToken'],
...
export function MetricRequestToJSONTyped(value?: MetricRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'debug': value['debug'],
        'from': value['from'],
        'publicDashboardAccessToken': value['publicDashboardAccessToken'],
