...
export interface QueryDataResponse {
     ...
     */
    responses?: { [key: string]: DataResponse; };
}
...
export function QueryDataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryDataResponse {
    ...
    return {
        ...
        'responses': json['Responses'] == null ? undefined : (mapValues(json['Responses'], DataResponseFromJSON)),
    };
}
...
export function QueryDataResponseToJSONTyped(value?: QueryDataResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'Responses': value['responses'] == null ? undefined : (mapValues(value['responses'], DataResponseToJSON)),
    };
}
