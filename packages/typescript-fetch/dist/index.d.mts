...
declare class CorrelationsApi extends BaseAPI {
     ...
     */
    getCorrelationsRaw(initOverrides?: RequestInit | InitOverrideFunction): Promise<ApiResponse<Array<Correlation>>>;
    /**
     * Gets all correlations.
     */
    getCorrelations(initOverrides?: RequestInit | InitOverrideFunction): Promise<Array<Correlation>>;
    /**
...
declare class UsersApi extends BaseAPI {
     ...
     * Get users.
     */
    searchUsersRaw(requestParameters: UsersApiSearchUsersRequest, initOverrides?: RequestInit | InitOverrideFunction): Promise<ApiResponse<SearchUserQueryResult>>;
    /**
     * Returns all users that the authenticated user has permission to view, admin permission required.
     * Get users.
     */
    searchUsers(requestParameters?: UsersApiSearchUsersRequest, initOverrides?: RequestInit | InitOverrideFunction): Promise<SearchUserQueryResult>;
    /**
